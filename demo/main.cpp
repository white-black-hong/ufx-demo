...
int showmenu1()
{
   ...
   cerr<<" [2]  333002 证券普通委托                       "<<endl;
   cerr<<" [3]  333104 证券持仓查询                       "<<endl;
   cerr<<" [4]  331300 证券股东信息查询                   "<<endl;
   cerr<<" [5]  333101 证券委托查询                       "<<endl;
   cerr<<" [6]  333102 证券成交查询                       "<<endl;
   cerr<<" [7]  400 证券行情查询                          "<<endl;
   cerr<<" [0]  EXIT                                      "<<endl;
   cerr<<" [111]  COME BACK                                   "<<endl;
   cerr<<"------------------------------------------------"<<endl;
   return 0;
